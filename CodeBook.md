CODE BOOK
This code book describes the variables, the data, and transformations that have been performed to clean up the raw data.
...
The data set 'filtered' shows all data points of both train and test set. 
The data set 'averaged' shows the average for each signal and activity label across the data set 'filtered'.